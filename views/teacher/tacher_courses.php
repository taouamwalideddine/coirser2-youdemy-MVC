...
<script>
    ...
    function openEditModal(courseId) {
        ...
        document.getElementById('editCourseForm').setAttribute('action','index.php?action=edite_course');
        ...
        fetch(`index.php?action=get_course&id=${courseId}`)
            ...
            .then(course => {
                ...
                document.getElementById('editCourseForm').setAttribute('action',`index.php?action=edite_course&id=${course.id}`);
